...
class _BookingScreenState extends State<BookingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    "Select Time",
    style: TextStyle(
    fontFamily: "Lobster-Regular", fontSize: 23),
    ),
    ),
    ],
    ),
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: selectedTime == _time ? Colors.transparent : Colors
                      .grey.shade500,
                  offset: Offset(0.0, 0.0),
                  blurRadius: 15.0),
              BoxShadow(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              color: _time.isBefore(now)
                  ? Colors.grey
                  : selectedTime == _time ? Colors.white : Colors.black,
            ),
          ),
        ),
      ),
